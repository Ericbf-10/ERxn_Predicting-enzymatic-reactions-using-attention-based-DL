...
uniprot_files = os.path.join(processed_data_dir, '01_uniprotID_and_EC_raw.csv')
...
data.to_csv(f'{processed_data_dir}/02_uniprotID_and_EC_reduced.csv', index=None, sep=',')
